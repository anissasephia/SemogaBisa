...
import { of } from 'rxjs';
import { LocationService } from 'src/app/services/loaction/location.service';
...
describe('RegisterPage', () => {
  ...
  it('given page init when geolocation is enabled, then fill adress details with user location', fakeAsync(() => {
    fixture.detectChanges();
    tick(10);
